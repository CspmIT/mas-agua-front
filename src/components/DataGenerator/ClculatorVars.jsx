			...
			<div className='flex w-full flex-wrap justify-center items-start gap-3 p-2 '>
				...
				<div className='flex w-full justify-center gap-3'>
					...
					<TextField
						...
						helperText={errors.calc_unit_topic && errors.calc_unit_topic.message}
						defaultValue={'ms'}
					>
					...
					<TextField
						...
						helperText={errors.calc_period && errors.calc_period.message}
					/>
					<TextField
						select
						label='Unidad'
						...
						helperText={errors.calc_unit_period && errors.calc_unit_period.message}
						defaultValue={'ms'}
					>
						<MenuItem value='ms'>Milisegundos</MenuItem>
						<MenuItem value='s'>Segundos</MenuItem>
					...
					<TextField
						...
						helperText={errors.calc_type_period && errors.calc_type_period.message}
						defaultValue={'last'}
					>
				...
				{!data ? (
					<div className='flex items-center justify-center'>
						<Button variant='contained' color={'info'} onClick={addCalcVar}>
							agregar <Add />
						</Button>
					</div>
				) : null}
